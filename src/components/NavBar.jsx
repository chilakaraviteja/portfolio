...
const NavBar = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 bg-blue-500 text-white">
      <div className="md:flex items-center justify-between py-4 md:px-10 px-7">
        ...
        <ul
          className={`md:flex md:items-center pb-0 absolute md:static bg-blue-500 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-7 transition-all duration-500 ease-in-out ${
        ...
        >
          {Links.map(({ name, link }, index) => (
            <li key={index} className="text-xs md:ml-8  md:my-0 my-5 ">
              ...
              <a
                href={link}
                className="hover:text-gray-900 duration-300 font-[Merienda]"
              >
                {name}{" "}
              </a>
            </li>
